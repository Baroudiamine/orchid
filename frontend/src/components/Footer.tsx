      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="font-inter text-ivory-white/80 mb-6 leading-relaxed">
          ...
          <div>
            ...
            <p className="font-inter text-ivory-white/80 mb-4">
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              <Input
                ...
                className="bg-ivory-white/10 border-ivory-white/20 text-ivory-white placeholder:text-ivory-white/60"
                required
              />
              <Button type="submit" variant="luxury" className="w-full font-inter">
                S'abonner
              </Button>
            </form>
          </div>
      ...
      <div className="border-t border-ivory-white/20">
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="font-inter text-ivory-white/60 text-sm">
